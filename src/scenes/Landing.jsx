      ...
      <div className="md:order-2 flex justify-center basis-3/5 z-10 mt-16 md:mt-32">
        {isAboveMediumScreens ? (
          ...
          >
            <img 
              alt="profile"
              className="hover:saturate-200 transition duration-500 z-10 w-full
        ...
        <div className="z-30 basis-2/5 mt-12 md:mt-32">
          ...
          >
            ...
            <p className="mt-10 mb-7 text-center md:text-start">
              Hey everyone! I'm full stack developer with a focus on front end, take a look at my portfolio!
            </p>
          </motion.div>
